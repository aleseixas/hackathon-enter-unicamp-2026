...
export const demoAdminDashboard: AdminDashboard = {
  ...
  historical_simulation: {
    ...
    description:
      'SIMULACAO HISTORICA independente: aderencia, aceite e economia foram calibrados sobre a base sintetica e permanecem separados dos registros feitos no navegador.',
  },
